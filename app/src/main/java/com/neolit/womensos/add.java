...
public class add extends AppCompatActivity {
    ...
    Button btn;
    ListView mContacts;
    EditText mEmail;  // Declare email EditText
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmail = findViewById(R.id.mEmail);  // Initialize email field
        ...
        btn.setOnClickListener(v -> {
            ...
            if (!name.isEmpty() && !number.isEmpty() && !email.isEmpty()) {
                boolean isInserted = databaseHelper.addContact(name, number, email);
                if (isInserted) {
